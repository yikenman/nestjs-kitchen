...
const salt = 'mq9hDxBVDbspDR6n';

describe('E2E test', () => {
  describe('Fastify (@fastify/cookie, @fastify/session)', () => {
    ...
    describe('Mix scenario', () => {
      describe('Apply jwt authz on top of another JWT authz', () => {
      ...
      describe('Apply jwt authz on top of another session authz', () => {
      ...
      describe('Apply session authz on top of another session authz', () => {
        const base = '/mix/session-4-under-session-3';

        it('should get session token with the @fastify/session options', async () => {
          const res = await request(app.getHttpServer()).get(`${base}/log-in?userId=${userId}`);
      ...
      describe('Apply session authz on top of another jwt authz', () => {
  ...
  describe('Fastify (@fastify/secure-session)', () => {
    let app: NestFastifyApplication;
    ...
    describe('Mix scenario', () => {
      ...
      describe('Apply session authz on top of another session authz', () => {
        ...
        it('should get session token with the @fastify/secure-session options', async () => {
          const res = await request(app.getHttpServer()).get(`${base}/log-in?userId=${userId}`);
